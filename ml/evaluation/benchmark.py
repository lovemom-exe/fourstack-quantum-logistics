...
def benchmark_plots(csv_path: str) -> None:
    ...
    for metric in error_metrics:
        ...
        plt.title(f'Model Comparison: {metric_title} vs Feature Count (k)', fontsize=13, fontweight='bold', pad=15)
        plt.xlabel('Number of Features (k)', fontsize=11, fontweight='semibold')
        ...
        # Hiển thị đồ thị trực tiếp lên màn hình tương tác
        plt.show()
